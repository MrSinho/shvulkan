...
extern void shPipelineWriteDynamicDescriptorBufferMemory(const VkDevice device, const uint32_t descriptor_idx, void* p_descriptor_buffer_data, ShVkPipeline* p_pipeline);
