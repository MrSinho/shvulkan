    ...
    let
      ...
      shvulkan = (with pkgs; stdenv.mkDerivation {
          ...
          src = pkgs.fetchgit {
            ...
            rev = "0d30000e0c74bcfb089aa1f7c3e0f3dc5380176c";
            sha256 = "2faQQzdU7MWIGhEobF0HwpHrQYiyul7GdUOQEOVftqM=";#dummy 0000000000000000000000000000000000000000000000000000
